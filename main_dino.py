...
def get_args_parser():
    ...
    parser.add_argument('--arch', default='vit_small', type=str,
        choices=['vit_tiny', 'vit_small', 'vit_base','vit_small_patch8_512', 'xcit', 'deit_tiny', 'deit_small'] \
...
def train_dino(args):
    ...
    dataset = FlatImageFolder(args.data_path, transform=transform)
    ...
    # utils.restart_from_checkpoint(
    #     os.path.join(/workspace/dino_output_small_patch8/checkpoint0100.pth),
    #     run_variables=to_restore,
    #     student=student,
    #     teacher=teacher,
    #     # optimizer=optimizer,
...
GLOBAL_CROP_SIZE = 96        # match MAE image size
LOCAL_CROP_SIZE = 48         # half of global, typical DINO small crop
class DataAugmentationDINO(object):
    def __init__(self, global_crops_scale, local_crops_scale, local_crops_number):
        ...
        self.global_transfo1 = transforms.Compose([
            transforms.RandomResizedCrop(GLOBAL_CROP_SIZE, scale=global_crops_scale, interpolation=Image.BICUBIC), #224
        ...
        self.local_transfo = transforms.Compose([
            transforms.RandomResizedCrop(LOCAL_CROP_SIZE, scale=local_crops_scale, interpolation=Image.BICUBIC), #96
            flip_and_color_jitter,
